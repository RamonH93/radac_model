# py_abac requires pymongo which requires sqlalchemy and dnspython module as well!
...
client = MongoClient(
    "mongodb+srv://radac:radac@radac-db.r628p.azure.mongodb.net/admin?retryWrites=true&w=majority")
